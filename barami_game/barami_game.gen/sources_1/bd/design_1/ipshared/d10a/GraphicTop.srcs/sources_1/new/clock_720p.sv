...
module clock_720p (
    input  wire logic clk_125m,       // input clock (125 MHz)
    ...
    localparam MULT_MASTER=29.75;  // master clock multiplier
    ...
    localparam IN_PERIOD=8.0;      // period of master clock in ns (10 ns == 100 MHz)
