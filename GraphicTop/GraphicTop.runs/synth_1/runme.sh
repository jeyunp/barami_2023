...
HD_PWD='C:/Users/Jeyun/Desktop/fpga/barami_project-2023/barami_game/GraphicTop/GraphicTop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GraphicTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GraphicTop.tcl
